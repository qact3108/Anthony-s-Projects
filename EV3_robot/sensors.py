# Sensors communication module for Alpha industry product
...
import digitalio
from adafruit_lsm6ds.lsm6dsox import LSM6DSOX  # Gyroscope
import adafruit_tca9548a
from adafruit_vl53l4cd import VL53L4CD  # Distance

# from i2c_button import I2C_Button #Button
from Button_i2c import I2C_Button


class Color_sensor:
    def __init__(self, port) -> None:  # initialze the sensor
        i2c = board.I2C()  # uses board.SCL and board.SDA
        tca = adafruit_tca9548a.TCA9548A(i2c)
        self.sensor = AS7341(tca[port])
        self.sensor.atime = 19
        self.sensor.astep = 599

    def get_value_tuple(self):
        return (
            self.sensor.all_channels
        )  # return current in all channels as a tuple type

    def get_value_415(self):
        return self.sensor.channel_415nm  # return current in 415nm channel
...
class Distance_sensor:
    ...
    def get_distance(self):
        try:
            ...
            self.sensor = VL53L4CD(tca[self.port])
            return 0
...
class Button:
    def __init__(self) -> None:  # initialze the sensor
        # i2c = board.I2C()  # uses board.SCL and board.SDA
        # tca = adafruit_tca9548a.TCA9548A(i2c)
        # self.sensor = I2C_Button(tca[port])
        i2c = busio.I2C(board.SCL, board.SDA)
        self.sensor = I2C_Button(i2c)
        self.sensor.debounce_ms
...
class Gyroscope:
    def __init__(self, port) -> None:
        i2c = board.I2C()
        tca = adafruit_tca9548a.TCA9548A(i2c)
        self.sensor = LSM6DSOX(tca[port])
        pass

    def get_acceleration_tuple(self):
        return self.sensor.acceleration  # returns the acceleration as a tuple

    def get_acceleration_x(self):
        x, y, z = self.get_acceleration_tuple()
        return x
    ...
    def get_gyro_tuple(self):
        return self.sensor.gyro  # returns the gyro value as a tuple

    def get_gyro_x(self):
        x, y, z = self.get_gyro_tuple()
        return x
...
class I2C_Button:
    ...
    def __init__(self, i2c_addr=_DEF_ADDR, dev_id=_DEV_ID, name="button"):
        self.i2c = board.I2C()
...
#           self._int |= _INT_PR
#       else:
#           self._int &= ~_INT_PR & 0xFF# Write your code here :-)
